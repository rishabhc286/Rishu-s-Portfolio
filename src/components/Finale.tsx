...
const Finale = () => {
  ...
  const socialLinks = [
    { icon: Github, href: "https://github.com/rishabhc286", label: "GitHub" },
    {
      icon: Linkedin,
      href: "https://linkedin.com/in/rishabhc286",
      label: "LinkedIn",
    },
    {
      icon: Mail,
  ...
  const marqueeTags = [
    "Rishabh Chaudhary 🚀",
    "2nd Yr Student | Java | JavaScript | Node.js | AI",
      ...
      <div className="max-w-6xl mx-auto px-6 py-20 flex flex-col items-center">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 text-center">
          ...
          <p className="text-xs font-mono text-black/70 uppercase tracking-widest leading-loose max-w-sm">
            From India IN to the World 🌍 • Crafting Scalable Digital Products
          </p>
        </div>
      </div>
