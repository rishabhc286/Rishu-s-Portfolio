...
const ContactSection = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const phoneNumber = "+918690833473";
  ...
  const copyEmail = () => {
    navigator.clipboard.writeText("chaudharyrishabh008@gmail.com");
    setCopied(true);
        ...
        <div className="space-y-8 md:space-y-10">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 p-4 border border-foreground/10 bg-white/50 hover:border-black transition-colors duration-300">
              ...
              <div>
                ...
                <p className="font-mono text-sm">+91 8690833473</p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              {[
                { Icon: Github, href: "https://github.com/rishabhc286" },
                { Icon: Linkedin, href: "https://linkedin.com/in/rishabhc286" },
                {
                  Icon: Twitter,
